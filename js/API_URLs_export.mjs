 ...
 const userProfile = `${baseUrl_API}/api/v1/social/profiles/adrian_b/media`;
...
export {signinrUrl, registerUrl, posts, authorization, postId, post, post_author, userProfile};
